...
public class App {
	...
	public static void main(String[] args) throws NumberFormatException, IOException, ClassNotFoundException {
		...
		do {
			...
			case 1 : 
				...
				Order o=service.createOrder(tempOrder);
			...
			case 3:
				...
				List<Order> list1=service.getAllOrder(); 
				System.out.println("saving orders please wait");
	...
	//	 objectOutputStream.writeObject(new Order(2,new Date(),10,"mobile","Marry",false));
